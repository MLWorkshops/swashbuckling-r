...
tapply(coins, groupings, mean)
```

### Arrays and matrices

An array is an N-dimensional series of data entries of all the same type. A matrix is a special case of an array that is 2-dimensional.
...
As a data structure, a data frame can contain multiple types of data. Let's create some data.
...
The functions `apply()`, `tapply()` and `lapply()` allow you to perform a specified functions across array objects.
